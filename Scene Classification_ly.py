...
train_parameters = {
    ...
    "label_dict": {},  # 标签字典
    "num_epochs": 30,  # 训练轮数
    "train_batch_size": 196,  # 训练时每个批次的大小
...
def data_enhance(target_path):
    target_path = target_path + 'scenes'
    i = 0
...
class ConvPool(fluid.dygraph.Layer):
    ...
    def __init__(self,
        ...
        for i in range(groups):  # groupgroups组数
...
class VGGNet(fluid.dygraph.Layer):
    ...
    def __init__(self):
        ...
        self.convpool01 = ConvPool(3, 64, 3, 2, 2, 2,
                                   act="relu")  # num_channels, num_filters, filter_size, pool_size, pool_stride, groups, conv_stride=1, conv_padding=1,act=None, pool_type='max'
...
infer_src_path = '/home/aistudio/data/data35458/scene_infer.zip'
